...
interface HomeAndroidProps {
  onCalendarClick: (type: 'apple' | 'google') => void;
}

function HomeAndroid({ onCalendarClick }: HomeAndroidProps) {
    ...
    <div className="home-android">
      <div className="home-content">
        ...
        <div className="main-content">
          ...
          {/* Google Calendar Card SVG로 교체 - 기존 버튼 + 아이콘 + 텍스트 모두 제거 */}
          <div className="calendar-card-wrapper">
            {/* 상하 애니메이션 채팅 버튼 */}
            <img 
              src={chatButton} 
              alt="채팅 버튼" 
              className="chat-button-animated"
            />
            <img 
